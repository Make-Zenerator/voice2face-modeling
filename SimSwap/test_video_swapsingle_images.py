...
from util.gifswap import gif_swap_save
import os
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        for image_path in image_list:
            ...
            path_name = image_path.split('.')[0]
            output_path = os.path.join(opt.output_path, path_name+'.mp4')
            temp_results_dir = os.path.join(opt.temp_path, path_name)

            video_swap(opt.video_path, latend_id, model, app, output_path, temp_results_dir=temp_results_dir,\
